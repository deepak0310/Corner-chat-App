...
let qbLoginPassword = "da8dl&af3sovl"



extension DefaultsKeys {
	
	static let UserId =	DefaultsKey<String>("UserDefaultKey_UserId")
	static let QBId =	DefaultsKey<String>("UserDefaultKey_QBId")
}

struct Icons {
	static let USER = UIImage(named: "ic_user")
	static let EMAIL = UIImage(named: "ic_email")
	static let PASSWORD = UIImage(named: "ic_password")
	static let BIRTHDATE = UIImage(named: "ic_birthdate")
	static let PHONE = UIImage(named: "ic_phone")
	static let SEX = UIImage(named: "ic_sex")
}
...
class Color: UIColor {
	...
	static let AppBlue			= UIColor.init(red: 84, green: 199, blue: 252)
	static let AppGreen			= UIColor.init(red: 33, green: 131, blue: 128)
	static let AppLightGreen	= UIColor.init(red: 3, green: 206, blue: 164)
	static let AppOrange		= UIColor.init(red: 255, green: 153, blue: 51)
