...
//  Corner
//
//  Created by MobileGod on 14/02/2017.
...
public class DefaultsKey<ValueType>: DefaultsKeys {
	// TODOx: Can we use protocols to ensure ValueType is a compatible type?
...
// TODOx: Use generic subscripts when they become available
...
extension UserDefaults {
	...
	// TODOx: It would probably make sense to have support for statically typed dictionaries (e.g. [String: String])
...
extension UserDefaults {
	// TODOx: Ensure that T.RawValue is compatible
...
extension UserDefaults {
	// TODOx: Can we simplify this and ensure that T is NSCoding compliant?
