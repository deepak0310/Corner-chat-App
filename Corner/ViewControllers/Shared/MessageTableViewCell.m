...
- (UIImageView *)thumbnailView {
	...
	if (!_thumbnailView) {
		...
		_thumbnailView.frame = CGRectMake(0, 0, kMessageTableViewCellAvatarHeight, kMessageTableViewCellAvatarHeight);
		_thumbnailView.translatesAutoresizingMaskIntoConstraints = NO;
		_thumbnailView.userInteractionEnabled = NO;
		_thumbnailView.backgroundColor = [UIColor colorWithWhite:1 alpha:1.0];
