...
import UIKit
 ...
 class NewDialogViewController: UsersListTableViewController, QMChatServiceDelegate, QMChatConnectionDelegate {
    ...
    func openNewDialog(dialog: QBChatDialog!) {
        ...
        //else perform segue
        self.performSegue(withIdentifier: "goToChat".localized, sender: nil)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "UserTableViewCellIdentifier", for: indexPath as IndexPath) as! UserTableViewCell
